...
hours=$(osascript -e 'display dialog "Quantas horas deseja ajustar?" default answer "0"')

# Abrir um prompt para escolher o nome do arquivo
filepattern=$(osascript -e 'display dialog "Qual o nome do arquivo?" default answer "celular-*"')
